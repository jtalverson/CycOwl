...
class App(customtkinter.CTk):
    def __init__(self):
       ...
       #self.attributes('-topmost', True)
        ...
        self.up_connect = customtkinter.CTkButton(master=self.sidebar_frame, text = "Update Connections" , border_width=2, command = lambda: callUpdate(self))
        self.up_connect.grid(row=6, column=0, padx=(20, 20), pady=(20, 20), sticky="nsew")

        self.key_button = customtkinter.CTkButton(self.sidebar_frame, text="Keyboard", border_width=2, command = lambda: callKey(self))
        self.key_button.grid(row = 7, column = 0, padx = 20, pady = (20 , 10))
        
        self.exit_button = customtkinter.CTkButton(self.sidebar_frame, text="Exit", border_width=2, command= lambda: callClose(self))
        ...
        self.wifi_connect = customtkinter.CTkButton(master=self.wifi_frame, text = "Connect Wi-Fi" , border_width=2, command =lambda: callConnectWifi(self))
        ...
        self.blue_connect = customtkinter.CTkButton(master=self.blue_frame, text = "Connect Bluetooth" , border_width=2, command = lambda: callConnectBluetooth(self))
        self.blue_connect.grid(row=3, column=2, padx=(20, 20), pady=(20, 20), sticky="nsew")
        self.blue_disconnect = customtkinter.CTkButton(master=self.blue_frame, text = "Disconnect Bluetooth" , border_width=2, command = lambda: disconnect(self))
        ...
        self.zoom = customtkinter.CTkButton(master=self.final, text = "Connect to Zoom" , border_width=2, command = lambda: join_zoom(self))
